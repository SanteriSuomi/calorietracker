...
CREATE INDEX "meal_userId_date_idx" ON "meal" USING btree ("user_id","date");--> statement-breakpoint
CREATE INDEX "session_userId_idx" ON "session" USING btree ("user_id");--> statement-breakpoint
CREATE UNIQUE INDEX "user_settings_userId_key" ON "user_settings" USING btree ("user_id");--> statement-breakpoint
