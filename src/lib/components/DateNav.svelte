...
<div class="flex items-center justify-between py-2">
	<Button variant="ghost" size="icon" onclick={prevDay} aria-label={m.date_nav_prev_aria()}>
	...
	<Button variant="ghost" size="icon" onclick={nextDay} disabled={date >= today()} aria-label={m.date_nav_next_aria()}>
